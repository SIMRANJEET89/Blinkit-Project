      ...
      <Devider/>
        <div>
          ...
          <div className="border border-green-500 px-4 py-2 rounded bg-green-100 w-fit">
            <p className="font-semibold text-lg lg:text">{DisplayPriceInRupees(data.price)}</p>
            </div>
        </div>
        {
          data.stock === 0 ? (
           ...
           <button className="border-green-700 bg-green-600 hover:bg-green-700 text-white px-3 py-1 m-2 rounded">Add</button>
          )
        }
