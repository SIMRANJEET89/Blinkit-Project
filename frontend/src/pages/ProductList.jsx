...
const ProductList = () => {
  ...
  return (
    <section className="sticky top-h-24 lg:top-20">
      <div className="container sticky top-24 mx-auto grid grid-cols-[90px_1fr] md:grid-cols-[200px_1fr] lg:grid-cols-[270px_1fr]">
        {/* sub category */}
        <div className="min-h-[88vh] max-h-[88vh] overflow-y-scroll p-2 grid gap-1 shadow-md scrollbarCustom bg-white py-2">
          {displaySubCategory.map((s, index) => {
            ...
            return (
              <Link
                to={link}
                className={`w-full p-2 bg-white lg:flex items-center lg:w-full lg:h-16 box-border lg:gap-4 border-b hover:bg-green-100 cursor-pointer
              ...
              >
                ...
                <p className="lg:mt-0 text-xs text-center lg:text-base lg:text-left">
                  {s.name}
                </p>
              </Link>
            );
