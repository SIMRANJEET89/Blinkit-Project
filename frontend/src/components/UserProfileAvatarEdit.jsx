  ...
  return (
    <section className="fixed top-0 bottom-0 left-0 right-0 bg-black/60 p-4 flex items-center justify-center">
      <div className="bg-white max-w-sm w-full rounded p-4 flex flex-col items-center justify-center">
        <button onClick={close} className="text-green-600 w-fit block ml-auto">
<IoClose size={20}/>
        </button>
        ...
        <form onSubmit={handleSubmit} className="mt-5">
          <label htmlFor="uploadProfile">
            <div className="border cursor-pointer border-yellow-400 hover:bg-yellow-300 px-4 py-1 rounded text-sm my-5">
